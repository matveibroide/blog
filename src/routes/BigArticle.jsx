                            ...
                            <div className={s.userInfoWrapper}>
                                <div className={s.userInfo}>
                                    ...
                                    <img className={s.avatar} src={article?.author?.image ? `${article?.author?.image}` : `${image}`} alt=""/>
                                                ...
                                                {username === currentUser ? <div style={{width:'100%',display:'flex',justifyContent:'space-between'}}><button onClick={() => dispatch(removeArticle(slug,token))} style={{color:'red',background:'none',padding:'3%',border:'1px solid red',borderRadius:'4px',width:'78px'}} >delete</button>

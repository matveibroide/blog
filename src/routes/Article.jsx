...
export default function Article({description,author,title,slug,tagList,createdAt,favorited,likes}) {
        ...
        <article className={s.article}>
                ...
                <div className={s.details}>
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',width:'fit-content'}}>
                        ...
                        {favorited ? <svg onClick={()=>unlikeAnArticle(slug,token).then(data => console.log(data))} width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 2.56911C7.26154 1.33835 6.03077 0.476807 4.55385 0.476807C2.46154 0.476807 0.861542 2.07681 0.861542 4.16911C0.861542 8.23065 3.07693 8.84604 8 13.523C12.9231 8.84604 15.1385 8.23065 15.1385 4.16911C15.1385 2.07681 13.5385 0.476807 11.4462 0.476807C9.96923 0.476807 8.73846 1.33835 8 2.56911Z" fill="#FF0707"/>
                            ...
                            <div style={{display:'flex',alignItems:'center'}}>
                                <svg onClick={() => likeAnArticle(slug,token).then(data => console.log(data)).catch(e => console.log(e))} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">

                ...
                <div className={s.details}>
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',width:'fit-content'}}>
                        ...
                        {favorited ? <div style={{display:'flex',alignItems:'center'}}>
                            <svg onClick={() => handleClick(slug,token,favorited)} width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div style={{display:'flex',alignItems:'center'}}>
                                <svg onClick={() => handleClick(slug,token,favorited)} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">

...
export default function Articles() {
    ...
    return (
      <>
       ...
       :
       <div  style={{opacity:`${opacity}`,transition:'1s',height:`${height}`}} className="articles">

            {spinner ? (<Spin size="large" style={{margin:'20% auto',width:'100%',height:'50%'}}/>) : null}
            {
            ...
            {loading || spinner ? null : <Pagination current={page} onChange={(pageNum)=> handleClick(pageNum)} style={{margin:'0 auto',width:'fit-content', padding:'20px'}} total={50} />}
